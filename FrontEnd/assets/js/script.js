...
fetchWorks()
  .then(data => {
        ...
        // Puis crée des éléments HTML pour les afficher dans la galerie principale et la galerie modale.
        ...
        // Ajoute un gestionnaire d'événements pour supprimer un projet lorsqu'on clique sur l'icône de suppression.
...
// 2. Récupération et affichage des catégories
// Appel fetch category pour récupérer les données des catégories.
fetchCategory()
    .then(data => {
        ...
        // Boucle sur chaque catégorie et crée des éléments HTML pour les afficher dans les filtres et le menu déroulant de téléchargement.
...
// Gère la soumission du formulaire pour ajouter un nouveau projet.
